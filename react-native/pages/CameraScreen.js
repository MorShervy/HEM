...
export default class CameraScreen extends Component {
    ...
    renderPicUri() {
        return (
            <Modal
                ...
                <View style={{ flex: 0.1, flexDirection: "row", justifyContent: "space-between", backgroundColor: '#2C3E50' }}>
                    <TouchableOpacity
                ...
                <Image source={{ uri: this.state.picUri }}
                    style={{ flex: 0.9 }} />
            </Modal>
    ...
    render() {
        ...
        const content = this.state.openModalPic ? this.renderPicUri() : cameraScreenContent;
